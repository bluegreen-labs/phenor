...
comparison = readRDS("/data/Dropbox/Research_Projects/working/phenocam_model_comparison/data/comparison.rds")
melaas = readRDS("/data/Dropbox/Research_Projects/working/phenocam_model_comparison/data/melaas.rds")

# generate figure as a pdf
pdf("~/Figure_6.pdf",8,9)
# set the outline
